...
class Privilegio(Resource):
    ...
    def get(self):
        ...
        response = functions.monta_sql_select_tabela_unica(args, 'privilegios')
    ...
    def post(self):
        ...
        response = functions.monta_sql_insert_tabela_unica(args, 'privilegios')
        falha = functions.verifica_falha_requisicao(response)
    ...
    def put(self):
        ...
        response = functions.monta_sql_update_tabela_unica(args, 'privilegios')
        falha = functions.verifica_falha_requisicao(response)
    ...
    def delete(self):
        ...
        response = functions.monta_sql_delete_tabela_unica(args, 'privilegios')
        falha = functions.verifica_falha_requisicao(response)
